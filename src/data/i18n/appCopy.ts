...
export const UI_COPY: Record<UiLang, any> = {
  id: {
    ...
    open: "BUKA",
    closedAt: (openHour: string) => `TUTUP (Buka ${openHour})`,
    ...
    closedNowAt: (openHour: string) => `Sedang Tutup - Buka Jam ${openHour}`,
  ...
  en: {
    ...
    open: "OPEN",
    closedAt: (openHour: string) => `CLOSED (Open ${openHour})`,
    ...
    closedNowAt: (openHour: string) => `Closed Now - Opens at ${openHour}`,
